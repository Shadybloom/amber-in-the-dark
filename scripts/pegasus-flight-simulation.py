...
d_samples['Пегас'] = {
        ...
        'Предельная мощность (мегаватт)':0.03*2,
        'Размах крыла (метров)':3,
        'Хорда крыла (метров)':0.35,
        'Толщина крыла (метров)':0.35/10,
        'Несущая площадь крыла (квадратных метров)':1.0,
...
d_samples['Bulk Biceps (6000 кВт)'] = {
        'Масса аппарата (килограмм)':200,
        'Запас энергии (мегаджоулей)':400,
        'Предельная мощность (мегаватт)':3*2,
        'Объём двигателя (кубометров)':0.4,
        'Размах крыла (метров)':0.3,
        'Хорда крыла (метров)':0.35,
        'Толщина крыла (метров)':0.35/10,
        'Несущая площадь крыла (квадратных метров)':0.1 + 0.3,
        'Фронтальная площадь крыла (квадратных метров)':(0.35/10)*0.3,
        'Длина фюзеляжа (метров)':1.5,
        'Ширина фюзеляжа (метров)':0.45,
        'Высота фюзеляжа (метров)':0.5,
        'Фронтальная площадь фюзеляжа (квадратных метров)':0.25,
        'Горизонтальная площадь фюзеляжа (квадратных метров)':0.74,
        'Коэффициент лобового сопротивления фюзеляжа':0.35,
        'Радиус колеса шасси (метров)':0.15,
        'Дисколёт':False,
        'Поляра профиля крыла':d_samples['Пегас']['Поляра профиля крыла'],
        }

d_samples['Пегас 0 lvl (4 кВт)'] = {
        # Маленький, или с антигравами.
        'Масса аппарата (килограмм)':35,
        'Запас энергии (мегаджоулей)':40,
        'Предельная мощность (мегаватт)':0.004,
        'Объём двигателя (кубометров)':0.4,
...
d_samples['Пегас 0 lvl (7 кВт)'] = {
        # Расчётная мощность заклинания Gust из DnD 5e
        'Масса аппарата (килограмм)':70,
        'Запас энергии (мегаджоулей)':40,
        'Предельная мощность (мегаватт)':0.0073,
        'Объём двигателя (кубометров)':0.4,
        'Размах крыла (метров)':4,
        'Хорда крыла (метров)':0.35,
        'Толщина крыла (метров)':0.35/10,
...
d_samples['Пегас 0 lvl (15 кВт)'] = {
        # Расчётная мощность заклинания Gust из DnD 5e
        'Масса аппарата (килограмм)':70,
        'Запас энергии (мегаджоулей)':40,
        'Предельная мощность (мегаватт)':0.015,
        'Объём двигателя (кубометров)':0.4,
        'Размах крыла (метров)':4,
        'Хорда крыла (метров)':0.35,
        'Толщина крыла (метров)':0.35/10,
...
d_samples['Пегас 1 lvl (30 кВт)'] = {
        'Масса аппарата (килограмм)':70,
        'Запас энергии (мегаджоулей)':40,
        'Предельная мощность (мегаватт)':0.03,
        'Объём двигателя (кубометров)':4.4,
        'Размах крыла (метров)':4,
        'Хорда крыла (метров)':0.35,
        'Толщина крыла (метров)':0.35/10,
...
d_samples['Пегас 2 lvl (60 кВт)'] = {
        'Масса аппарата (килограмм)':70,
        'Запас энергии (мегаджоулей)':((2 * 40 + 40 * (2 - 1) * 2)) / 2,
        'Предельная мощность (мегаватт)':((2 * 0.03 + 0.03 * (2 - 1) * 2)) / 2,
        'Объём двигателя (кубометров)':4.4,
        'Размах крыла (метров)':4,
        'Хорда крыла (метров)':0.35,
        'Толщина крыла (метров)':0.35/10,
...
d_samples['Пегас 3 lvl (120 кВт)'] = {
        'Масса аппарата (килограмм)':70,
        'Запас энергии (мегаджоулей)':((2 * 40 + 40 * (3 - 1) * 3)) / 2,
        'Предельная мощность (мегаватт)':((2 * 0.03 + 0.03 * (3 - 1) * 3)) / 2,
        'Объём двигателя (кубометров)':4.4,
        'Размах крыла (метров)':4,
        'Хорда крыла (метров)':0.35,
        'Толщина крыла (метров)':0.35/10,
...
d_samples['Пегас 4 lvl (210 кВт)'] = {
        'Масса аппарата (килограмм)':70,
        'Запас энергии (мегаджоулей)':((2 * 40 + 40 * (4 - 1) * 4)) / 2,
        'Предельная мощность (мегаватт)':((2 * 0.03 + 0.03 * (4 - 1) * 4)) / 2,
        'Объём двигателя (кубометров)':4.4,
        'Размах крыла (метров)':4,
        'Хорда крыла (метров)':0.35,
        'Толщина крыла (метров)':0.35/10,
...
d_samples['Пегас 8 lvl (870 кВт)'] = {
        'Масса аппарата (килограмм)':70,
        'Запас энергии (мегаджоулей)':((2 * 40 + 40 * (8 - 1) * 8)) / 2,
        'Предельная мощность (мегаватт)':((2 * 0.03 + 0.03 * (8 - 1) * 8)) / 2,
        'Объём двигателя (кубометров)':4.4,
        'Размах крыла (метров)':4,
        'Хорда крыла (метров)':0.35,
        'Толщина крыла (метров)':0.35/10,
...
d_samples['Пегас 11 lvl (1680 кВт)'] = {
        'Масса аппарата (килограмм)':70,
        'Запас энергии (мегаджоулей)':((2 * 40 + 40 * (11 - 1) * 11)) / 2,
        'Предельная мощность (мегаватт)':((2 * 0.03 + 0.03 * (11 - 1) * 11)) / 2,
        'Объём двигателя (кубометров)':4.4,
        'Размах крыла (метров)':4,
        'Хорда крыла (метров)':0.35,
        'Толщина крыла (метров)':0.35/10,
...
d_samples['Пегас 20 lvl (5730 кВт)'] = {
        'Масса аппарата (килограмм)':70,
        'Запас энергии (мегаджоулей)':((2 * 40 + 40 * (20 - 1) * 20)) / 2,
        'Предельная мощность (мегаватт)':((2 * 0.03 + 0.03 * (20 - 1) * 20)) / 2,
        'Объём двигателя (кубометров)':4.4,
        'Размах крыла (метров)':4,
        'Хорда крыла (метров)':0.35,
        'Толщина крыла (метров)':0.35/10,
...
d_samples['Рэйнбоу "Рэйнбум" Дэш'] = {
        ...
        'Масса аппарата (килограмм)':70,
        'Запас энергии (мегаджоулей)':4500,
        'Объём двигателя (кубометров)':4.4,
        #'Предельная мощность (мегаватт)':180,
        'Предельная мощность (мегаватт)':0.03*420,
        'Размах крыла (метров)':4,
        'Хорда крыла (метров)':0.35,
        'Толщина крыла (метров)':0.35/10,
        'Несущая площадь крыла (квадратных метров)':1.4,
...
d_samples['Лёгкий грузовой планёр (1 lvl пегас, 30 кВт)'] = {
...
d_samples['Лёгкий грузовой планёр (0 lvl пегас, 7 кВт)'] = {
        # http://www.aeros.com.ua/structure/al/al12_ru.php
        'Масса аппарата (килограмм)':300,
        'Запас энергии (мегаджоулей)':40,
        'Предельная мощность (мегаватт)':0.007,
        'Объём двигателя (кубометров)':4.4,
        'Размах крыла (метров)':13.3,
        'Хорда крыла (метров)':1,
        'Толщина крыла (метров)':1/10,
        ...
        'Радиус колеса шасси (метров)':0.15,
        'Дисколёт':False,
        'Поляра профиля крыла':d_samples['Лёгкий грузовой планёр (1 lvl пегас, 30 кВт)']['Поляра профиля крыла'],
        }        

d_samples['Тяжёлый грузовой планёр (18 1lvl пегасов)'] = {
        ...
        'Запас энергии (мегаджоулей)':40 * 18,
        'Предельная мощность (мегаватт)':0.03 * 18,
...
def create_parser():
    ...
    parser.add_argument('-R', '--runway-length',
                        action='store', dest='runway_length', type=int,
                        help='Взлётная полоса (метров)'
                        )
...
def f_glide_model (d_flight, d_LD_ratio, silent=False, energy_collect=False):
    ...
    while d_flight['altitude'] >=0 and d_flight['second'] <= max_seconds:
        ...
        optimum_angle, engine_thrust, engine_required_energy, engine_overheating = \
        ...
        # Дополняем словарь:
        d_flight['engine_heat'] = d_flight['engine_heat'] + engine_overheating
        ...
        if silent is not True:
            print ('{0:5} | {1:6} | {2:6} | {3:6} | {4:6} | {5:6}'.format(
                    d_flight['second'],
                    round(d_flight['aircraft_speed']),
                    round(d_flight['path']), round(d_flight['altitude']),
                    round(engine_thrust / 9.8),
                    round(engine_required_energy * 1000),
                    #round(d_flight['engine_heat'] * 1000)
                    ))
    return d_flight_log
...
def f_autopilot_takeoff (d_flight, d_LD_ratio, aircraft_mass, energy_balance):
    ...
    if engine_air_volume == 0:
        ...
        return optimum_angle, engine_thrust, engine_required_energy, engine_overheating
...
def f_pegasus_mind (d_flight, d_plane, d_LD_ratio):
    ...
    if altitude == 0:
        ...
        #print (engine_thrust, engine_required_energy)
        return optimum_angle, engine_thrust, engine_required_energy, engine_overheating
    # Полёт с набором высоты:
        ...
        if aircraft_speed < optimum_speed:
            ...
            engine_thrust, engine_required_energy, engine_overheating, engine_mode = \
                    f_engine_mode_choice (required_thrust, engine_air_volume)
            #print(engine_mode)
            #print ('Перегрев (кДж):', round(engine_overheating * 1000, 2))
            return optimum_angle, engine_thrust, engine_required_energy, engine_overheating
        if aircraft_speed >= optimum_speed:
            #print('off')
            return optimum_angle, 0, 0, 0
...
# Проверка, указана ли длина взлётной полосы:
if namespace.runway_length:
    runway_length = namespace.runway_length
else:
...
d_flight = {
        'engine_heat':0,
        'aircraft_mass':aircraft_mass,
        # Начальная скорость -- скорость бега пегаса:
        #'aircraft_speed':0,
        'aircraft_speed':10,
...
if namespace.model is True:
    ...
    print('Time  | (m/s)  | meters | height | kgf    | kW    ')
    print('----- | ------ | ------ | ------ | ------ | ------')
