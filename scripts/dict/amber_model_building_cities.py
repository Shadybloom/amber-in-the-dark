...
metadict_detail['Железнодорожная станция (эксплуатация)'] = {
        ...
        'Городское жильё, общежитие, железнодорожное (квадратный метр)':240,
        }

metadict_detail['Железнодорожный пост (эксплуатация)'] = {
        # 5-10 километров пути -- 12 путевых смотрителей.
        # Общежития уже включены в "_-Обслуживание двухколейных главных путей".
        'Городское жильё, общежитие, железнодорожное (квадратный метр)':60,
        }
