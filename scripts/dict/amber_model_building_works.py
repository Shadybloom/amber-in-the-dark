...
# Строительство зданий, сооружений (коррекция величин):
    # TODO: всё это нужно перенести в works_buildning и привести к единому формату.
...
metadict_model['Устройство стен одноэтажной каркасной конструкции (квадратный метр)'] = {
        'Устройство стен одноэтажной каркасной конструкции (100 квадратных метров)':1/100,
        }

metadict_model['Устройство стен двухэтажной каркасной конструкции (квадратный метр)'] = {
        'Устройство стен двухэтажной каркасной конструкции (100 квадратных метров)':1/100,
        }
...
metadict_model['Устройство кафельного покрытия (квадратный метр)'] = {
        'Устройство покрытий на цементном растворе из плиток (100 квадратных метров)':1/100,
        }

metadict_model['Устройство покрытий из паркетных досок (квадратный метр)'] = {
        'Устройство покрытий из паркетных досок (100 квадратных метров)':1/100,
        }

metadict_model['Оклейка обоями (квадратный метр)'] = {
        'Оклейка обоями (100 квадратных метров)':1/100,
        }
...
metadict_detail['Установка дверных блоков (квадратный метр)'] = {
        'Установка дверных блоков (100 квадратных метров)':1/100,
        }
...
metadict_model['Установка мебели с креплением (штука)'] = {
        'Установка мебели с креплением (100 штук)':1/100,
        }
...
metadict_model['Простая штукатурка известковым раствором (квадратный метр)'] = {
        'Простая штукатурка известковым раствором (100 квадратных метров)':1/100,
        }

metadict_model['Простая штукатурка известково-глинопесчанным раствором (квадратный метр)'] = {
        'Простая штукатурка известково-глинопесчанным раствором (100 квадратных метров)':1/100,
        }
...
metadict_model['Ударно-вращательное бурение скважин (кубометр)'] = {
        'Ударно-вращательное бурение скважин (метр)':1,
        }

metadict_model['Подрывные работы (кубометр)'] = {
        # Буровзрывные работы.
        'Ударно-вращательное бурение скважин (метр)':1,
        'Подрыв скалы средней прочности (кубометр)':1,
        }
...
metadict_model['Котлован (кубометр)'] = {
        'Разработка грунта упряжными грейдерами, с помощью Mold_Earth (кубометр)':1,
        '-Земляные работы (кубометр)':1,
        }
...
metadict_model['Траншея (кубометр)'] = {
        # TODO:
            # Щиты для опалубки.
        'Разработка грунта упряжными скреперами, с помощью Mold_Earth (кубометр)':1,
        '-Земляные работы (кубометр)':1,
        }

metadict_model['Разработка грунта упряжными грейдерами (кубометр)'] = {
        'Разработка грунта упряжными грейдерами (1000 кубометров)':1/1000,
        '-Земляные работы (кубометр)':1,
        }

metadict_model['Разработка грунта упряжными грейдерами, с помощью Mold_Earth (кубометр)'] = {
        'Разработка грунта упряжными грейдерами, с помощью Mold_Earth (1000 кубометров)':1/1000,
        '-Земляные работы (кубометр)':1,
        }
...
metadict_detail['Разработка грунта упряжными скреперами, с помощью Mold_Earth (кубометр)'] = {
        'Разработка грунта упряжными скреперами, с помощью Mold_Earth (1000 кубометров)':1/1000,
        '-Земляные работы (кубометр)':1,
        }

metadict_detail['Разработка щебня упряжными скреперами, с помощью Mold_Earth (кубометр)'] = {
        'Разработка щебня упряжными скреперами, с помощью Mold_Earth (1000 кубометров)':1/1000,
        '-Земляные работы (кубометр)':1,
        }

metadict_detail['Разработка бутового камня гидродинамическая, с помощью Shape_Water (кубометр)'] = {
        'Разработка бутового камня гидродинамическая, с помощью Shape_Water (1000 кубометров)':1/1000,
        '-Земляные работы (кубометр)':1,
        }
...
metadict_model['Расчистка среднего леса киркомотыгами (квадратный метр)'] = {
...
metadict_model['Раствор отделочный известковый (кубометр)'] = {
        'Раствор отделочный известковый (100 кубометров)':0.01,
        }

metadict_model['Раствор отделочный известково-глинопесчанный (кубометр)'] = {
        'Раствор отделочный известково-глинопесчанный (100 кубометров)':0.01,
        }
...
metadict_model['Ударно-вращательное бурение скважин (100 метров)'] = {
        ...
        # http://www.norm-load.ru/SNiP/Data1/54/54265/index.htm#i694753
            ...
            # Измеритель: 1 м проходки
        # TODO: порталцемент убираем из списка. Вызывает зацикливание.
...
metadict_model['Подрыв скалы средней прочности (кубометр)'] = {
...
metadict_detail['Разработка бутового камня гидродинамическая, с помощью Shape_Water (1000 кубометров)'] = {
        # TODO: ллучше раздели на две работы.
            # Отдельно дробление породы заклинаниями,
            # Отдельно перевозка обломков.
        ...
        '_-Работа бригады шахтёров (нормо-часов)':600,
...
metadict_model['Разработка грунта упряжными скреперами (1000 кубометров)'] = {
        ...
        'Использование скрепера упряжного на 0.5-кубометра (часов)':35.8 * 6,
        }
...
metadict_detail['Разработка грунта упряжными скреперами, с помощью Mold_Earth (1000 кубометров)'] = {
        ...
        'Использование скрепера упряжного на 0.5-кубометра (часов)':214.8,
        }

metadict_detail['Разработка щебня упряжными скреперами, с помощью Mold_Earth (1000 кубометров)'] = {
        ...
        '_-Работа бригады землекопов (нормо-часов)':400,
        'Использование грейдера упряжного для строительства (часов)':20.52,
        'Использование скрепера упряжного на 0.5-кубометра (часов)':314.8,
        }

metadict_model['Разработка грунта упряжными грейдерами (1000 кубометров)'] = {
        # TODO:
            # Не используется
...
metadict_model['Разработка грунта упряжными грейдерами, с помощью Mold_Earth (1000 кубометров)'] = {
        # https://vignette.wikia.nocookie.net/mlp/images/d/dc/Stallions_Angry_S1E11.png
        # Производительность человека с малой пехотной лопаткой -- 0.5 кубометра/час
        # С большой сапёрной лопатой -- 1 кубометр/час
        '_-Работа бригады землекопов (нормо-часов)':300,
...
metadict_model['Устройство покрытий на цементном растворе из плиток (100 квадратных метров)'] = {
...
metadict_model['Устройство покрытий из паркетных досок (100 квадратных метров)'] = {
...
metadict_model['Оклейка обоями (100 квадратных метров)'] = {
...
metadict_model['Установка мебели с креплением (100 штук)'] = {
...
metadict_model['Простая штукатурка известковым раствором (100 квадратных метров)'] = {
...
metadict_model['Устройство стен двухэтажной каркасной конструкции (100 квадратных метров)'] = {
        # http://www.norm-load.ru/SNiP/Data1/56/56034/index.htm#i1066631
        # Таблица ГЭСН 10-02-019 Сборка стен каркасной конструкции
            # 01. Сборка наружных и внутренних стен с установкой рам каркаса,
            # верхних и нижних обвязок, заполнением каркаса плитами фибролитовыми.
...
metadict_model['Устройство стен одноэтажной каркасной конструкции (100 квадратных метров)'] = {
        # http://www.norm-load.ru/SNiP/Data1/56/56034/index.htm#i1066631
        # Таблица ГЭСН 10-02-019 Сборка стен каркасной конструкции
            # 01. Сборка наружных и внутренних стен с установкой рам каркаса,
            # верхних и нижних обвязок, заполнением каркаса плитами фибролитовыми.
...
metadict_model['Простая штукатурка известково-глинопесчанным раствором (100 квадратных метров)'] = {
...
metadict_model['Раствор отделочный известковый (100 кубометров)'] = {
        # Таблица ГЭСН 06-01-083 Приготовление тяжелых отделочных растворов:
        # http://www.norm-load.ru/SNiP/Data1/54/54267/index.htm#i998199
        # 01. Укладка в емкость и перемешивание цемента, извести и песка.
        # 02. Затворение сухой смеси водой с перемешиванием.
...
metadict_model['Раствор отделочный известково-глинопесчанный (100 кубометров)'] = {
        # Для отделки печей.
