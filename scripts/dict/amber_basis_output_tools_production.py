...
metadict_detail['|||Инструмент текстильный (парус брезентовый) (квадратный метр)'] = {
        # TODO: проблема зацикливания скрипта. Перевозка парусов, которые используются для перевозки.
            # Для решения этого есть уравнения межотраслевого баланса.
            # Используй балансный метод:
            # - Здесь требование к числу парусов.
            # - А производство средств производства привяжем к фабрикам в population.
            # В точности как уже прявязали локальные производства соли и одежды.
...
metadict_detail['|||Утварь стеклянная (лампа светляковая 10x10x20-см, 200 Лм)'] = {
        # TODO: Светляки жгут масло с эффективностью люминесцентных ламп.
            # Нужно оценить использование светляковых ламп через tools.
