...
metadict_detail['|||Инструмент текстильный (парус брезентовый) (квадратный метр)'] = {
        # TODO: парус брезентовый. Ошибка зацикливания. Исправлена в скрипте.
            # При конфигурации с deep >150 ошибка не влияет на вывод. Цикл небесконечный.
            # Суть проблемы. Перевозка парусов, которые используются для перевозки.
...
metadict_detail['|||Утварь стеклянная (люстра светокристальная 40x40x20-см, 1200 Лм)'] = {
        # TODO: Заклинания для создания лампы. Быстрая оценка, пока без производства.
            # Заклинаний хватает только на 51% ламп. И это без уличного освещения.
...
metadict_detail['|||Ёмкость плетёная (корзина 10-литровая)'] = {
        ...
        # Грубые из ивы -- 1 кг.
        '_Производство плетёной тары (корзина 10-литровый)':1,
...
metadict_detail['|||Ёмкость плетёная (корзина 50-литровая)'] = {
        ...
        '_Производство плетёной тары (корзина 50-литровый)':1,
        '_Утилизация плетёной тары (килограмм)':5.25 * 0.5,
        }

metadict_detail['|||Ёмкость плетёная (корзинка 1-литровая)'] = {
        '_Производство плетёной тары (корзина 1-литровый)':1,
...
metadict_detail['|||Инструмент чугунный литой (щипцы для дров)'] = {
        # TODO: не забудь утилизацию и переплавку чугуна.
...
metadict_detail['|||Инструмент чугунный литой (кувалда)'] = {
        # Масса изделия -- 6-10 кг
        'Литьё чугунное, инструменты (килограмм)':8,
        }
