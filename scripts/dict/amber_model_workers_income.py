...
# Заметки:
    ...
    # Хронология добычи золота:
        ...
        # ----------------- | ----------- | ------------- | ------------
        # 1500 до н.э.      | 250-300 млн | -             | <4000 тонн
        # -500-500 н.э.     | 255         | ~3500 тонн    | -
        # 500-1500 годы     | 390-438     | ~2500         | <10 000
        # 17 век            | 579-682     | <1000         | -
        # 18 век            | 682-1036    | 1890          | -
        # 19 век            | 1036-1650   | 11 600        | <29 000
        # 20 век*           | 1650-6080   | 120 000       | -
        # 2001-2020 годы    | 6080-8145   | 57 000        | -
        # * 60% золотодобычи 20 века, это ЮАР, Южная Африка (руды 0.000072% золота, до 0.0009%)
