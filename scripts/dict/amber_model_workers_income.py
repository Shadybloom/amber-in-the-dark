#----
# Заметки:
    # Денежная масса Эквестрии:
    # - 33%, 340 млн бит -- золото (255 тонн, 116 кг на 10k пони)
    # - 15%, 153 млн бит -- серебро (2300 тонн, 1045 кг на 10k)
    # - 7%, 71.4 млн бит -- драгоценности (19.2M карат, 1.75 кг/10k)
...
# Хронология добычи золота:
    ...
    # За всю историю добыто 200k тонн золота (18% в золотых запасах)
...
# Хронология добычи серебра:
    ...
    # Денежная масса династии Мин (1570-1649, 250 млн) -- до 26 362 тонн серебра
        ...
        # Запас серебра <1055 кг на 10k населения (скорее 300-500 кг/10k)
