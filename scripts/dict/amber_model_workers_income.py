#----
# Заметки:
    # Денежная масса Эквестрии (оборот и запасы):
    # - 33%, 340 млн бит -- золото (255/1275 тонн, 116 кг на 10k пони)
    # - 15%, 153 млн бит -- серебро (2.3/11.5k тонн, 1045 кг на 10k)
    # - 7%, 71.4 млн бит -- драгоценности (19.2/190M карат, 1.75 кг/10k)
    # Оставшиеся 45% обеспечены зерном, металлами, топливом, т.д.
# Монетная масса в обороте на 10 тысяч жителей (1895 год):
    # Год  | Страна | Людей  | Золото | Серебро | Разм. монета | Банкноты
    # ---- | ------ | ------ | ------ | ------- | ------------ | ------------
    # 1896 | США    | 71 млн | 123 кг | 1944 кг | 15 кг золота | 50 кг золота
...
# Монетная масса и запасы казначейств (1895 год) -- в тоннах драгоценных металлов:
    ...
    # Контрибуция Германии (Франция, 1871 год) -- 5 млрд франков, 1451 тонн золота
...
# Хронология добычи серебра:
    ...
    # Добыча серебра (Римская империя, 200 год. 55 млн) -- 200 тонн/год
        # Денежная масса Римской империи (150 год, 70 млн) -- 2025 тонн серебра (9% ВВП)
    ...
    # Добыча серебра (Mexico, Peru, Bolivia, 1545-1800) -- 40kt (85% мировой добычи)
