...
# Денежная база и запасы казначейств Эквестрии:
    ...
    # Оставшиеся 45% банкнот обеспеченные зерном, металлами, топливом, т.д.
...
# Монетная масса и запасы казначейств (1895 год) -- в тоннах драгоценных металлов:
    ...
    # Контрибуция Германии (Франция, 1871 год) -- 1451 тонн золота (5 млрд франков)
    # Контрибуция Японии (Китай, 1895 год) -- 270 тонн (38 млн фунтов стрелингов)
...
# Хронология добычи золота:
    ...
    # Золотодобыча (Рим, Лас-Медулас, -100-300) -- 1500 тонн
