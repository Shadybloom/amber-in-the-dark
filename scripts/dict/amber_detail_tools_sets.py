...
metadict_detail['Инструменты кухонные (комплект)'] = {
        ...
        '|Поварёшка стальная (0.125 литра)':1,
        '|Поварёшка деревянная (0.25 литра)':2,
        }

metadict_detail['Ёмкости кухонные (комплект)'] = {
        '|Квашня деревянная (25 литров)':2,
        '|Ведро деревянное (10 литров)':2,
        '|Ковш деревянный (5 литров)':2,
        '|Миска глиняная (5 литров)':2,
        '|Миска глиняная (3 литра)':2,
        '|Кувшин глиняный (5 литров)':1,
        '|Кувшин глиняный (3 литра)':1,
        '|Котелок чугунный (10 литров)':1,
        ...
        '|Чугунок (3 литра)':1,
        '|Чугунок (1 литр)':1,
        '|Сотейник чугунный (2 литра)':1,
        '|Сковорода чугунная (1 литр)':1,
        '|Форма для выпечки хлеба (2 литра)':5,
        '|Противень жестяной (12 литров)':1,
        #'|Форма для выпечки пирога (0.5 литра)':5,
        #'|Форма для выпечки маффинов (0.125 литра)':10,
        }

metadict_detail['Приборы столовые (комплект)'] = {
        # TODO:
            # Всё фигня, переделывай, раз уж разобрались.
        '|Нож столовый':2,
        '|Блюдо для еды (2 литра)':2,
        '|Миска для еды (1 литр)':5,
        '|Блюдце для еды (0.5 литра)':5,
        '|Кружка для питья (0.5 литра)':5,
...
metadict_army['Использование богатой зимней одежды (дней/год)'] = {
        '||Шляпа (хлопок)':1 / 2 / 360,
        '||Бушлат (хлопок)':1 / 2 / 360,
        '||Кафтан (хлопок)':1 / 2 / 360,
        '||Пиджак (хлопок)':1 / 2 / 360,
        '||Жилет (хлопок)':1 / 2 / 360,
        '||Брюки (хлопок)':1 / 2 / 360,
        '||Жакет (хлопок)':1 / 2 / 360,
        '||Платье (хлопок)':1 / 2 / 360,
        '||Галоши (каучук)':1 / 2 / 360,
        '||Ботинки (джут)':1 / 2 / 360,
        }

metadict_army['Использование богатой летней одежды (дней/год)'] = {
        '||Чепчик (хлопок)':1 / 360,
        '||Плащ (хлопок)':1 / 360,
        '||Пиджак (хлопок)':1 / 2 / 360,
        '||Жилет (хлопок)':1 / 2 / 360,
...
metadict_army['Использование простой зимней одежды (дней/год)'] = {
        '||Шапка (хлопок)':1 / 360,
        '||Плащ (хлопок)':1 / 2 / 360,
        '||Пальто (парусина+хлопок)':1 / 2 / 360,
        '||Ветровка (парусина)':1 / 360,
        '||Брюки (парусина)':1 / 360,
        '||Ботинки (джут)':1 / 360,
        }

metadict_army['Использование простой летней одежды (дней/год)'] = {
        '||Шляпа (солома)':1 / 2 / 360,
        '||Чепчик (лён)':1 / 2 / 360,
        '||Плащ (хлопок)':1 / 2 / 360,
        '||Плащ (парусина)':1 / 2 / 360,
        '||Шлёпанцы (джут)':1 / 360,
        }
...
metadict_army['|Одежда богатая зимняя (комплект)'] = {
        # У понях любой костюм, это комбинезон. Копыта просовываются, пуговицы вдоль брюха застёгиваются.
        # А кроме костюмов в ходу плащи, пальто, ветровки и дождевики.
            # https://raw.githubusercontent.com/Shadybloom/amber-in-the-dark/master/images/fashion.png
...
metadict_army['|Одежда богатая летняя (комплект)'] = {
        # Головной убор
        '|Чепчик (хлопок)':1,
        # Верхняя одежда:
        '|Плащ (хлопок)':1,
...
metadict_army['|Одежда простая зимняя (комплект)'] = {
        # Головной убор
        '|Шапка (хлопок)':1,
        # Верхняя одежда:
        '|Плащ (хлопок)':1 / 2,
        '|Пальто (парусина+хлопок)':1 / 2,
        # Костюм:
        '|Ветровка (парусина)':1,
        '|Брюки (парусина)':1,
        # Бельё:
...
metadict_army['|Одежда простая летняя (комплект)'] = {
        # Головной убор
        '|Шляпа (солома)':1 / 2,
        '|Чепчик (лён)':1 / 2,
        # Верхняя одежда:
