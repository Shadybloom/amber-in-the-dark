...
metadict_detail['Инструменты печные (комплект)'] = {
        ...
        '|Инструмент чугунный литой (мангал 1-литровый)':1,
        '|Инструмент железный кованый (щипцы для дров)':1,
        '|Инструмент деревянный пиленый (совок печной)':1,
        '|Инструмент деревянный пиленый (лопата печная)':1,
...
metadict_detail['Инструменты кухонные (комплект)'] = {
        ...
        '|Инструмент жестяной кованый (воронка кухонная)':1,
        '|Инструмент деревянный пиленый (доска 40x60-см кухонная)':2,
        '|Инструмент деревянный пиленый (доска 60x75-см кухонная)':1,
        '|Инструмент стальной кованый (тёрка кухонная)':1,
        '|Инструмент деревянный долблёный (скалка)':2,
        '|Инструмент деревянный долблёный (ступа)':1,
        ...
        '|Инструмент стальной кованый (ложка мерная)':1,
        '|Инструмент стальной кованый (дуршлаг 0.25-литровый)':1,
        '|Инструмент стальной кованый (шумовка 0.125-литровая)':1,
        '|Инструмент стальной кованый (поварёшка 0.125-литровая)':1,
        '|Инструмент деревянный долблёный (поварёшка 0.25-литровая)':2,
...
metadict_detail['Ёмкости кухонные (комплект)'] = {
        ...
        '|Посуда керамическая (чайник 0.5-литровый)':1,
        ...
        '|Посуда чугунная литая (таз эмалированный 10-литровый)':1,
        '|Посуда чугунная литая (чугунок эмалированный 5-литровый)':1,
        ...
        '|Посуда жестяная кованая (противень 12-литровый)':1,
