#----
# Заметки
    # TODO: все комплекты снаряжения переносим в output_tools.
...
metadict_model['Тяжёлые машины дистанции пути'] = {
        # TODO: Маневровые локомотивы относятся к станциям.
        '|Дрезина (грузовая)':2,
...
metadict_model['||Инструменты железнодорожника (комплект)'] = {
        # TODO: Инструменты железнодорожника. Не используется. Допиливай.
