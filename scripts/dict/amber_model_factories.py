...
metadict_model['_Производство керамического кафеля (квадратный метр)'] = {
        ...
        # 45 штук/кв.метр
        'Глина мятая (кубометр)':(0.000225 * 45) * 1.3 * 1.2,
        '_-Формирование сырца кафеля (штук)':45,
        '_-Сушка сырца кирпича (кубометр)':(0.000225 * 45),
        '_-Обжиг кирпича в штабелях (кубометр)':(0.000225 * 45),
        '_Кирпичный завод (годовой оборот)':1 / 10000,
        }
