...
metadict_detail['_Производство цемента (килограмм)'] = {
        ...
        # Обжиг: 0.3 кг дров (4.8 МДж) = 1 кг цемента
        # Обжиг: 0.15 кг угля (4.35 МДж) = 1 кг цемента
        ...
        #'_-Процеживание глино-известнякового теста на железном сите (кубометр)':1 / 0.7,
        #'_-Помол глино-известнякового теста на шаровой мельнице (кубометр)':1 / 0.7,
        #'_-Обжиг цемента в шахтной печи (кубометр)':1 / 0.7,
        #'_-Дробление цемента в дробилке (кубометр)':1 / 0.7,
        #'_-Помол цемента на шаровой мельнице (кубометр)':1 / 0.7,
        #'_-Процеживание цемента на железном сите (кубометр)':1 / 0.7,
        #'_-Уплотнение цемента (кубометр)':1 / 0.7,
        #'Известь негашёная (килограмм)':0.085,
        }
