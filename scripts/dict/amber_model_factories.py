...
metadict_detail['_Производство смоляной пакли (килограмм)'] = {
        # TODO: Нужен разжижитель для дёгтя. Дегтярное масло?
...
metadict_model['_Добыча гравия (кубометр)'] = {
        ...
        'Котлован (кубометр)':1,
        'Разработка щебня упряжными скреперами, с помощью Mold_Earth (кубометр)':1,
        }
...
metadict_detail['_Добыча щебня (кубометр)'] = {
        ...
        'Разработка щебня упряжными скреперами, с помощью Mold_Earth (кубометр)':1 / 0.7,
...
metadict_detail['_Добыча бутового камня (кубометр)'] = {
        ...
        'Котлован (кубометр)':1 / 0.9,
        'Ударно-вращательное бурение скважин (кубометр)':1 / 0.9,
        'Разработка бутового камня гидродинамическая, с помощью Shape_Water (кубометр)':1 / 0.9,
        }
...
metadict_model['_Корчёвка смоляка (кубометр)'] = {
        ...
        '-Вырубленные леса (требуется/гектар)':10 / 250,
        }
