...
metadict_model['_-Пюрирование бобов (нормо-часов)'] = {
        '_-Приготовление пищи (нормо-часов)':1,
        }

metadict_model['_-Пюрирование фруктов (нормо-часов)'] = {
        '_-Обработка пищи (нормо-часов)':1,
        }
...
metadict_model['_-Отжим сока сахарного тростника (нормо-часов)'] = {
