...
metadict_army['Потребность в одежде, богатеи'] = {
...
metadict_army['Потребность в одежде, северяне'] = {
        '|Одежда простая летняя (комплект)':1,
        '|Одежда простая зимняя (комплект)':1,
...
metadict_army['Потребность в одежде, среднеземцы'] = {
        '|Одежда простая летняя (комплект)':1,
...
metadict_army['Потребность в одежде, южане'] = {
