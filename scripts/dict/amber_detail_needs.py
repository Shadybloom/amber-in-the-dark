...
metadict_detail['-Школьники (7-10 лет)'] = {
        ...
        # Только 85% жеребят обучаются грамоте. Земные ещё не втянулись.
        'Потребности основные (пони)':1,
...
metadict_detail['-Подмастерья (14-20 лет)'] = {
        ...
        # 5% закончивших школу -- высшее образование
        # Понячье высшее образование начинается с 14 лет.
        'Потребности основные (пони)':1,
        'Потребность в образовании, реальные училища (пони)':0.85 * 0.5 * 0.5,
        'Потребность в образовании, университеты (пони)':0.85 * 0.5 * 0.05,
        'Потребность в здравоохранении, подростки (пони)':1,
        }
...
metadict_army['Потребность в образовании, начальная школа (пони)'] = {
        # TODO: прежде всего квадратные метры на ученика, затем здания школ.
        # Сельские школы в пределах 2-4 км. от ферм и деревень, общежитий нет.
        }

metadict_army['Потребность в образовании, средняя школа (пони)'] = {
        # Не меньше половины живут в общежитиях при школах. Расстояния 5-20 км.
        }

metadict_army['Потребность в образовании, реальные училища (пони)'] = {
        # Почти все живут в общежитиях.
        }
