...
metadict_army['Потребность в одежде, богатеи (пони)'] = {
        ...
        # Наконец, украшения. Ленты, чепчики, брошки, кружева.
        ...
        'Использование богатой летней одежды (дней/год)':300,
        }
...
metadict_army['Потребность в одежде, северяне (пони)'] = {
        ...
        'Использование простой летней одежды (дней/год)':240,
        }
...
metadict_army['Потребность в одежде, среднеземцы (пони)'] = {
        ...
        'Использование простой летней одежды (дней/год)':300,
        }
...
metadict_army['Потребность в одежде, южане (пони)'] = {
        ...
        'Использование простой летней одежды (дней/год)':360,
        }
