...
# Производства (мебель)
    ...
    # Производство мебели (Grain into Gold)
        # Стул качественный -- 30-35 нормо-часов
        # Стул крестьянский -- 8 нормо-часов
...
# Бондарное производство (Германия, 1895 год)
    ...
    # Бондарное производство (капитал 31 000 рублей, 6 рабочих) -- 30 000 бочек/год
        ...
        # Бочка кустарно (120 литров, герметичная) -- 8 нормо-часов
        # "Grain into Gold" стр 34
...
# Производства (строительные материалы)
    ...
    # 1 кв.метр пропила (Grain into Gold) = 0.86 нормо-часа (пилами)
    # 1 кв.метр пропила (Grain into Gold) = 0.043 нормо-часа (лесопилка)
