...
#        }
#
#metadict_army['|---Плантации (гектар)'] = {
#        '|---Плантации (%)':[
#            '(value / x) * 100',
#            '|----Обжитые земли (гектар)',
#            ],
...
metadict_army['+--1 Жители мегаполисов (%)'] = {
        }

metadict_army['+--2 Жители городов (%)'] = {
        }

metadict_army['+--3 Жители городков (%)'] = {
        }

metadict_army['+--4 Жители селений (%)'] = {
        }

metadict_army['+--5 Жители деревень (%)'] = {
        }

metadict_army['+--6 Жители ферм (%)'] = {
        }
...
metadict_army['-Колёсная мазь (требуется/килограмм)'] = {
        }
...
metadict_army['+Бульон бобовый (%)'] = {
        }

metadict_army['+Бульон грибной (%)'] = {
        }

metadict_army['+Валежник (%)'] = {
        }

metadict_army['+Дикорастущие грибы (%)'] = {
        }

metadict_army['+Дикорастущие растения (%)'] = {
        }

metadict_army['+Дикорастущие ягоды (%)'] = {
        }

metadict_army['+Зола (%)'] = {
        }

metadict_army['+Луга дикоросов (%)'] = {
        }

metadict_army['+Луга медоносов (%)'] = {
        }

metadict_army['+Сок кленовый (%)'] = {
        }

metadict_army['++Солома сухая (%)'] = {
        }

metadict_army['++Опилки древесные (%)'] = {
        }

metadict_army['++Отруби зерновые (%)'] = {
        }
...
metadict_army['---Калорийность белков (%)'] = {
        }

metadict_army['---Калорийность жиров (%)'] = {
        }

metadict_army['---Калорийность углеводов (%)'] = {
        }

metadict_army['---Калорийность этанола (%)'] = {
        }
...
#metadict_army['-Испарение воды (грамм)'] = {
...
metadict_army['_+Работа врача (нормо-часов)'] = {
        }

metadict_army['_+Работа специалиста (нормо-часов)'] = {
        }

metadict_army['_+Работа учёного (нормо-часов)'] = {
        }
