#----
# Заметки:
    # Крупнейшие судоходные реки:
        # Река       | Длина  | Бассейн | Сток/год | Сток/га | Устье
        # ---------- | ------ | ------- | -------- | ------- | ------------
        # Янцзы *    | 6300km | 181M ha | 1000 km³ |  550 mm | Шанхай
        # Хуанхэ     | 5464   |  75     |   81     |  108    | Цзинань
        # Чжуцзян    | 2400   |  45     |  300     |  660    | Гонконг
        # Меконг     | 4023   |  81     |  500     |  617    | Хошимин
        # Иравади    | 2210   |  41     |  477     | 1151    | Янгон
        # Хонгха     | 1149   |  14     |  136     |  945    | Ханой
        # Ганг       | 2948   | 173     | 1351     |  780    | Бангладеш
        # Годавари   | 1465   |  31     |  113     |  360    | Раджамандри
        # Инд        | 3180   | 108     |  176     |  163    | Пакистан
        # Тигр+Ефрат | 2095   | 100     |   47     |   47    | Басра
        # Нил        | 5600   | 335     |   92     |   27    | Александрия
        # Конго *    | 4370   | 382     | 1307     |  342    | Матади
        # Нигер      | 4200   | 212     |  249     |  118    | Онича
        # Миссисипи  | 3770   | 298     |  400     |  130    | Новый Орлеан
        # S.Lawrence | 3058   | 127     |  555     |  438    | Квебек
        # Колумбия   | 2044   |  67     |  234     |  350    | Ванкувер
        # Амазонка   | 6992   | 692     | 7069     | 1022    | Белен
        # Ориноко    | 2250   |  99     | 1231     | 1243    | Венесуэла
        # Токантинс  | 2699   |  76     |  372     |  487    | Бразилия
        # Магдалена  | 1540   |  26     |  254     |  988    | Колумбия
        # Ла-Плата   | 2570   | 318     |  859     |  270    | Буэнос-Айрес
        # * Грузонапряжённость (Янцзы, 2025) -- 6 460 млн тонн (sic!)
        # * Гидроэнергия реки Конго -- 30/390 ГВт ~40% КИУМ (0.3/3.8 ПДж/км³)
        # Сток всех рек Земли -- 47 000 км³ (34% учтено в выше названных реках)
    ...
    # Крупнейшие реки Германии и Нидерландов:
        # Река       | Длина  | Бассейн | Сток/год | Сток/га | Устье
        # ---------  | ------ | ------- | -------- | ------- | ------------
        # Рейн *     | 1233km | 18.5Mha | 69.0 km³ | 375 mm  | Амстердам
        # Эльба *    | 1165   | 14.8    | 27.0     | 184     | Гамбург
        # Одер       |  840   | 12.5    | 15.2     | 221     | Штеттин
        # Везер      |  451   |  4.8    | 10.3     | 215     | Бремен
        # Маас       |  925   |  3.6    | 9.5      | 263     | Роттердам
        # Шельда     |  430   |  3.6    | 3.2      | 88      | Антверпен
        # Эмс        |  371   |  1.3    | 2.5      | 194     | Лер
        # Дунай *    | 2850   | 81.7    | 211      | 259     | Чёрное море
        # * Грузонапряжённость (Рейн, 1896) -- 7.9 млн тонн
        # * Грузонапряжённость (Эльба, 1895) -- 7.0 млн тонн
        # * Грузонапряжённость (Дунай, 1890) -- 20.8 млн тонн
        # * Грузонапряжённость (Дунай, 1977) -- 100 млн тонн
        # * Грузонапряжённость рек (Евросоюз, 2025) -- 380 млн тонн
        # https://upload.wikimedia.org/wikipedia/commons/3/36/HolyRomanEmpire_1618_russian.png
        # https://upload.wikimedia.org/wikipedia/commons/2/2a/Danube_basin.png
        # https://en.wikipedia.org/wiki/List_of_busiest_ports_in_Europe
        # https://ru.wikisource.org/wiki/ЭСБЕ/Рейн,_река
        # https://ru.wikisource.org/wiki/ЭСБЕ/Эльба,_река
        # https://ru.wikisource.org/wiki/ЭСБЕ/Дунай
    # Крупнейшие реки Европейской России и Урала:
        # Река       | Длина  | Бассейн | Сток/год | Сток/га | Устье
        # ---------- | ------ | ------- | -------- | ------- | ------------
        # Нева-Цна   | 1018km |  72M ha |   79 km³ |  110 mm | Петербург
        # Зап. Двина | 1020   |   9     |   21     |  243    | Рига
        # Днепр      | 2201   |  51     |   53     |  105    | Херсон
        # Дон        | 1870   |  42     |   22     |   51    | Азов
        # Волга *    | 3530   | 136     |  250     |  180    | Астрахань
        # ...Ока     | 1500   |  25     |   40     |  160    | Н.Новгород
        # ...Кама    | 1805   |  51     |  129     |  255    | Казань
        # Урал       | 2428   |  23     |   13     |   55    | Каспий. море
        # * Грузонапряжённость (Волга, 1880-е) -- 4.7 млн тонн
        # * Грузонапряжённость рек (Россия, 1880-е) -- 8.6 млн тонн
        # * Грузонапряжённость рек (Россия, 2024) -- 105 млн тонн
        # https://ru.wikisource.org/wiki/ЭСБЕ/Волга
        # https://ru.m.wikipedia.org/wiki/Речной_транспорт_России
        # https://ru.m.wikipedia.org/wiki/Судоходные_реки_России
        # https://ru.m.wikipedia.org/wiki/Волго-Балтийский_водный_путь
        # https://ru.m.wikipedia.org/wiki/Единая_глубоководная_система_Европейской_части_России
        # https://upload.wikimedia.org/wikipedia/commons/6/61/Oka_basin.png
    ...
    # Твёрдый сток рек:
        # - Хуанхэ * -- 1300 млн тонн ила (16 килограмм/кубометр)
        # - Амазонка -- >1000 млн тонн ила (142 грамм/кубометр)
        # - Миссисипи -- 360 млн тонн ила (900 грамм/кубометр)
        # - Янцзы -- 500 млн тонн ила (500 грамм/кубометр)
        # - Нигер -- 67 млн тонн ила (270 грамм/кубометр)
        # - Конго -- 50 млн тонн ила (40 грамм/кубометр)
        # * Хуанхэ в среднем течении размывает Лёссовое плато.
        # https://upload.wikimedia.org/wikipedia/commons/6/6c/Yellow_River_course_changes.gif
        # http://mor77.livejournal.com/481512.html

#----
# Гидротехнические сооружения:
    # Суэцкий канал (1859-1869 годы):
        # Античный канал от Нила: ширина 8m по дну, 17m поверхность, глубина 2m.
        # Длина: 160 км; ширина по поверхности 60-110m; по дну 22m (позже до 37m)
        # Глубина: 8 метров (впоследствии 9 метров)
        # Габариты: 1 / 2 * (22 + 80) * 8 * 1000 = 0.41 млн м³/км (65.6M m³ всего)
        ...
        # Стоимость (1892 год): 576M франков (220M рублей, 2.9 рубля/кубометр)
        # Оборот (1895 год): 3341 судов, 7.659Mt груза (10 франков/t, 3.8 руб/t)
        # Доход (1895 год): 80.7 млн франков, 25 млн расходы, 55.7 млн чистыми.
        # Лондон-Бомбей -- 59% прежнего плавания; Лондон-Шанхай -- 68% плавания.
    ...
    # Бриджватерский канал:
        # Длина 150 км
        # 91 шлюз (169 метров подъёма)
        # 126 мостов и водопроводов, 6 туннелей.
        # https://ru.wikisource.org/wiki/ЭСБЕ/Бриджватерский_канал
    # Плотины:
        # Дамба Три ущелья (Китай) -- 38M м³ бетона; сталь 256k тонн (6.7 кг/м³)
        # Дамба Гувера (1930 год) -- 3.4M м³ бетона; сталь 68k тонн (20 кг/м³)
            # 30% арматура; 58% обшивка, трубы; 12% конструкционная.
    ...
    # Оросительные каналы (Грузия, Караязская степь, 1867 год)
        # Орошаемые земли -- 15 тыс.га (??? гектара/человека, 50% территории)
        # Плотность -- 1.14 метра/гектар основных, 6.4 м/га второстепенных.
        # Протяжённость -- 2 основных по 15 и 5.5 км; 16 второстепенных по 6 км.
        ...
        # https://ru.m.wikipedia.org/wiki/Караязская_степь
        # https://ru.m.wikipedia.org/wiki/Кура
    # Оросительные каналы (Самаркандская область, 1897 год, 0.86 млн населения) 
        ...
        # Расход воды (1134 мм/год) -- 11 339 м³/га (на вегетацию 8889 м³/га)
    ...
    # Оросительные каналы (Хивинское ханство, 1900 год, 0.7 млн населения)
        # Орошаемые земли -- 262-833 тыс.га (0.34-1.09 га/чел, 4.3-11.3% земли)
    ...
    # Мелиорация (Российская империя, Полесье, 1870-1900 годы):
        ...
        # - 17 полушлюзов для задерживания воды во время засухи (219 вёрст каналов)
...
# Реки Эквестрии (по площади страны):
    # Расчёт бассейна реки по осадкам, коэффициенту испарения и водостоку:
        # Формула: водосток / (осадки × коэффициент испарения) = бассейн реки
        # Волга: 254 km3 / (667 mm * 0.28) to million ha = 136 млн гектаров
    # Расчёт осадков в регионе по водостоку:
        # Волжский бассейн (осадки 662 мм/год, испарение 475 мм/год)
        # Волга (3500 км, 254 км³/год, бассейн 1.360M км², сток 187 мм/год)
        # Формула:
        ...
        # y × (667 * 0.28 / 10^6) = 254 км³/год; y = 1 360 000 км²
...
metadict_detail['Суша Эквестрии, сеть рек и каналов (квадратный километр)'] = {
...
metadict_detail['Эквестрийские реки, большие (>500 км) (километр)'] = {
        ...
        'Потребность в водных путях (метр)':1000,
        }
...
metadict_detail['Эквестрийские каналы, судоходные (километр)'] = {
        # Каналы связывают окружные города на реках и их аграрные кантоны.
        # Одна лошадь-тяжеловоз со скоростью 3-5 км/час тащит баржу 30-50 тонн
...
metadict_detail['Река Кантер, судоходная (километр)'] = {
        ...
        # Обеспечение судоходной реки (Волга, 1890 год, от Рыбинска до устья, 2200 км?)
            # Грузооборот (Волга, 1840) -- 563-768 млн тонно-километров/год
            ...
            # Река Миссисипи -- 1270 км плоти; Притоки -- 1387 км плотин; Судоходство -- 4000 км
...
metadict_detail['Река Мэйнхен, судоходная (километр)'] = {
        # Судоходство, Иртыш (150 дней, конец апреля - начало октября)
        # Баржи 1800 тонн в большую воду.
        # Баржи 600 тонн в среднюю воду.
