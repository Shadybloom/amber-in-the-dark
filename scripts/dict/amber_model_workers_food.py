...
# Заметки:
    ...
    # Общественное питание отдельно, здесь только домашнее.

#----
# Потребление пищи и питья:
    # В среднем 72-81 минута/день
    # amber "Городской рацион (пони/год)" -n "1/360*60" -E "нормо-часов" | grep Потребление
...
metadict_model['_-Потребление закусок (нормо-часов)'] = {
        '_--Потребление пищи (нормо-часов)':1,
        }
