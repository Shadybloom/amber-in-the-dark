...
metadict_army['_Производство утвари, скатерть (хлопок)'] = {
        ...
        'Ткань хлопковая, сатин (квадратный метр)':2.2 * 1.3,
        'Нить хлопковая швейная (метр)':(2.2 + 1.3) * 2 * 4,
        }

metadict_army['_Производство утвари, шторы (хлопок)'] = {
        # 1.0 × 1.0 = 1 м²
        '_Производство утвари текстильной (нормо-часов)':5 / 60,
        'Ткань хлопковая, сатин (квадратный метр)':1.0 * 1.0,
        'Нить хлопковая швейная (метр)':(1.0 + 1.0) * 2 * 4,
        }

metadict_army['_Производство утвари, полотенце (хлопок)'] = {
        # 0.4 × 0.6 = 0.24 м²
        '_Производство утвари текстильной (нормо-часов)':1 / 60,
        'Ткань хлопковая, бязь (квадратный метр)':0.4 * 0.6,
        'Нить хлопковая швейная (метр)':(0.4 + 0.6) * 2 * 4,
        }
...
metadict_army['_Производство утвари, холст (лён)'] = {
        ...
        'Нить хлопковая швейная (метр)':(0.9 + 1.2) * 2 * 4,
        }
...
metadict_army['_Производство утвари, мешочек (лён)'] = {
        ...
        'Нить хлопковая швейная (метр)':(0.2 + 0.2) * 2 * 4,
        }
...
metadict_detail['_Производство белья, матрац (вата)'] = {
        ...
        'Ткань хлопковая, бязь (квадратный метр)':0.7 * 1.9 * 2,
        'Вата хлопковая швейная (кубометр)':0.7 * 1.9 * 0.06,
        'Нить хлопковая швейная (метр)':(0.7 * 1.9) * (40 + 40),
        }
...
metadict_detail['_Производство белья, одеяло стёганное (вата)'] = {
        ...
        # Пикование (прошивка): 40+40 нитей на метр матраца
        '_Производство белья (нормо-часов)':60 / 60,
        'Ткань хлопковая, бязь (квадратный метр)':1.5 * 2.0 * 2,
        'Вата хлопковая швейная (кубометр)':1.5 * 2.0 * 0.03,
        'Нить хлопковая швейная (метр)':(1.5 * 2.0) * (40 + 40),
        }
...
metadict_detail['_Производство белья, подушка стёганная (вата)'] = {
        ...
        'Ткань хлопковая, бязь (квадратный метр)':0.6 * 0.6 * 2,
        'Вата хлопковая швейная (кубометр)':0.6 * 0.6 * 0.12,
        }

metadict_detail['_Производство белья, простыня (хлопок)'] = {
        '_Производство белья (нормо-часов)':6 / 60,
        'Ткань хлопковая, бязь (квадратный метр)':1.5 * 2.0,
        'Нить хлопковая швейная (метр)':(1.5 + 2.0) * 2 * 4,
        }
...
metadict_detail['_Производство белья, одеяло лоскутное (вата)'] = {
        ...
        'Вата хлопковая швейная (кубометр)':1.5 * 2.0 * 0.03,
        'Нить хлопковая швейная (метр)':(1.5 * 2.0) * (20 + 20),
...
metadict_detail['_Производство белья, простыня (парусина)'] = {
        ...
        '_Производство белья (нормо-часов)':6 / 60,
        'Ткань льняная, парусина (квадратный метр)':1.5 * 2.0,
...
metadict_detail['_Производство одежды, бушлат (хлопок)'] = {
        ...
        'Ткань хлопковая, замша (квадратный метр)':1.85 / 0.85,
        'Ткань хлопковая, сатин (квадратный метр)':1.85 / 0.85 * 2,
        'Вата хлопковая швейная (кубометр)':1.85 * 0.01,
        'Нить хлопковая швейная (метр)':1.85 * (40 + 40),
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':((1.85 / 0.85) - 1.85) * 3,
        }
...
metadict_detail['_Производство одежды, пальто (хлопок)'] = {
        ...
        'Ткань хлопковая, бязь (квадратный метр)':1.85 / 0.85 * 2,
        'Вата хлопковая швейная (кубометр)':1.85 * 0.01,
        'Нить хлопковая швейная (метр)':1.85 * (40 + 40),
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':((1.85 / 0.85) - 1.85) * 3,
        }
...
metadict_detail['_Производство одежды, кафтан (хлопок)'] = {
        ...
        '_Производство одежды (нормо-часов)':8,
        'Ткань хлопковая, бархат (квадратный метр)':1.85 / 0.85,
        'Ткань хлопковая, сатин (квадратный метр)':1.85 / 0.85 * 2,
        'Вата хлопковая швейная (кубометр)':1.85 * 0.01,
        'Нить хлопковая швейная (метр)':1.85 * (40 + 40),
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':((1.85 / 0.85) - 1.85) * 3,
...
metadict_detail['_Производство одежды, платье (хлопок)'] = {
        ...
        '_Производство одежды (нормо-часов)':8,
        'Ткань хлопковая, бархат (квадратный метр)':2.3 / 0.85,
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':((2.3 / 0.85) - 2.3),
        }
...
metadict_detail['_Производство одежды, жакет (хлопок)'] = {
        ...
        'Ткань хлопковая, замша (квадратный метр)':1.4 / 0.85,
        'Ткань хлопковая, сатин (квадратный метр)':1.4 / 0.85,
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':((1.4 / 0.85) - 1.4) * 2,
        }
...
metadict_detail['_Производство одежды, жилет (хлопок)'] = {
        ...
        'Ткань хлопковая, замша (квадратный метр)':0.7 / 0.85,
        'Ткань хлопковая, сатин (квадратный метр)':0.7 / 0.85,
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':((0.7 / 0.85) - 0.7) * 2,
        }

metadict_detail['_Производство одежды, жилет (парусина)'] = {
        # Всего 0.7 кв.м ткани. Выкройка 85%
        '_Производство одежды (нормо-часов)':0.4,
        'Ткань льняная, парусина (квадратный метр)':0.7 / 0.85,
...
metadict_detail['_Производство одежды, плащ (хлопок)'] = {
        ...
        '_Производство одежды (нормо-часов)':1,
        'Ткань хлопковая, замша (квадратный метр)':2.1 / 0.95,
        'Ткань хлопковая, сатин (квадратный метр)':2.1 / 0.95 * 2,
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':((2.1 / 0.95) - 2.1) * 3,
        'Вата хлопковая швейная (кубометр)':2.1 * 0.01,
        'Нить хлопковая швейная (метр)':2.1 * (40 + 40),
        }
...
metadict_detail['_Производство одежды, пальто (парусина)'] = {
        # На 20 см ниже живота:
            # Грудь, круп: 0,4 × 0,4 × 2 = 0,32 м²
            # Спина, живот: 0,5 × 0,4 × 2 = 0.4 м²
            # Рукава, на все 4 ноги: ((2 × 3,14 × 0,05 × (0,05 + (20 / 50))) × (20 / 50)) × 4 = 0.23 м²
        ...
        '_Производство одежды (нормо-часов)':8,
        'Ткань льняная, брезент (квадратный метр)':1.85 / 0.85,
        'Ткань льняная, простая (квадратный метр)':1.85 / 0.85 * 2,
        '+Ткань льняная, лоскуты (доступно/квадратный метр)':((1.85 / 0.85) - 1.85) * 3,
        'Вата хлопковая швейная (кубометр)':1.85 * 0.01,
        'Нить хлопковая швейная (метр)':1.85 * (40 + 40),
        }
...
metadict_detail['_Производство одежды, ветровка (брезент)'] = {
        ...
        'Ткань льняная, парусина (квадратный метр)':2.0 / 0.85,
...
metadict_detail['_Производство одежды, чепчик (хлопок)'] = {
        # Всего 0.65 кв.м ткани. Выкройка 95%
        '_Производство одежды (нормо-часов)':0.2,
        'Ткань хлопковая, бязь (квадратный метр)':0.65 / 0.95,
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':((0.65 / 0.95) - 0.65),
        }
...
metadict_detail['_Производство одежды, шапка (хлопок)'] = {
        ...
        '_Производство одежды (нормо-часов)':1,
        'Ткань хлопковая, замша (квадратный метр)':0.65 / 0.85,
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':((0.65 / 0.85) - 0.65),
        }
...
metadict_detail['_Производство одежды, шляпа (хлопок)'] = {
        ...
        # Всего 0.53 кв.м ткани. Выкройка 85%
        '_Производство одежды (нормо-часов)':0.3,
        'Ткань хлопковая, замша (квадратный метр)':0.53 / 0.85,
        }
...
metadict_detail['_Производство одежды, чулки (хлопок)'] = {
        ...
        '_Производство одежды (нормо-часов)':0.2,
        'Ткань хлопковая, бязь (квадратный метр)':0.35 / 0.95,
        }
...
metadict_army['_Утилизация утвари, шторы (хлопок)'] = {
        ...
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':1.0 * 1.0,
        }

metadict_army['_Утилизация утвари, полотенце (хлопок)'] = {
        '_-Утилизация утвари (нормо-часов)':1 / 60,
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':0.4 * 0.6,
        }

metadict_army['_Утилизация утвари, скатерть (хлопок)'] = {
        '_-Утилизация утвари (нормо-часов)':3 / 60,
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':2.2 * 1.3,
        }
...
metadict_detail['_Утилизация белья, матрац (вата)'] = {
        ...
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':0.7 * 1.9 * 2,
...
metadict_detail['_Утилизация одежды, бушлат (хлопок)'] = {
        ...
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':1.85 * 3,
...
metadict_detail['_Утилизация одежды, платье (хлопок)'] = {
        ...
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':2.3,
        }
...
metadict_detail['_Утилизация одежды, плащ (хлопок)'] = {
        '_-Утилизация одежды (нормо-часов)':10 / 60,
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':2.1 * 3,
...
metadict_detail['_Утилизация одежды, жакет (хлопок)'] = {
        ...
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':1.4 * 2,
        }
...
metadict_detail['_Утилизация одежды, жилет (хлопок)'] = {
        '_-Утилизация одежды (нормо-часов)':5 / 60,
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':0.7 * 2,
        }

metadict_detail['_Утилизация одежды, чепчик (хлопок)'] = {
        '_-Утилизация одежды (нормо-часов)':2 / 60,
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':0.65,
        }
...
metadict_detail['_Утилизация одежды, шляпа (хлопок)'] = {
        '_-Утилизация одежды (нормо-часов)':2 / 60,
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':0.53,
        }

metadict_detail['_Утилизация одежды, чулки (хлопок)'] = {
        '_-Утилизация одежды (нормо-часов)':2 / 60,
        '+Ткань хлопковая, лоскуты (доступно/квадратный метр)':0.95,
        }
...
metadict_detail['_Утилизация одежды, пальто (парусина)'] = {
        '_-Утилизация одежды (нормо-часов)':10 / 60,
        '+Ткань льняная, лоскуты (доступно/квадратный метр)':1.85 * 3,
        '+Вата техническая (доступно/кубометр)':1.85 * 0.01,
        }
