...
metadict_army['_Производство утвари, скатерть 220x130 (хлопок)'] = {
        # 2.2 × 1.3 = 2.86 м²
...
metadict_army['_Производство утвари, шторы 100x100 (хлопок)'] = {
        # 1.0 × 1.0 = 1 м²
        '_Производство утвари текстильной (нормо-часов)':5 / 60,
...
metadict_army['_Производство утвари, полотенце 40x60 вафельное (хлопок)'] = {
        # 0.4 × 0.6 = 0.24 м²
...
metadict_army['_Производство утвари, холст 80x120 (лён)'] = {
        # 0.8 × 1.2 = 0.96 м²
        '_Производство утвари текстильной (нормо-часов)':1 / 60,
...
metadict_army['_Производство утвари, мешок (джут)'] = {
...
metadict_army['_Утилизация утвари, шторы 100x100 (хлопок)'] = {
        '_-Утилизация утвари (нормо-часов)':1 / 60,
        '+Ткань хлопчатая, лоскуты (доступно/квадратный метр)':1.0 * 1.0,
        }

metadict_army['_Утилизация утвари, полотенце 40x60 вафельное (хлопок)'] = {
        '_-Утилизация утвари (нормо-часов)':1 / 60,
...
metadict_army['_Утилизация утвари, скатерть 220x130 (хлопок)'] = {
        '_-Утилизация утвари (нормо-часов)':3 / 60,
        '+Ткань хлопчатая, лоскуты (доступно/квадратный метр)':2.2 * 1.3,
        }

metadict_army['_Утилизация утвари, холст 80x120 (лён)'] = {
        '_-Утилизация утвари (нормо-часов)':1 / 60,
...
metadict_army['_Утилизация утвари, мешок (джут)'] = {
        '_-Утилизация утвари (нормо-часов)':1 / 60,
...
metadict_detail['_Производство бязи (квадратный метр)'] = {
        ...
        '_-Беление тканей (квадратный метр)':1,
        #'_-Окраска тканей (квадратный метр)':1,
...
metadict_detail['_Производство хлопчатой нити (килограмм)'] = {
        # TODO: пили производство швейных нитей.
...
metadict_detail['_Производство хлопчатой ваты (килограмм)'] = {
        # TODO: делают из отходов производства пряжи.
            # Которых не хватает, поэтому добавляем 30% хлопка-сырца.
        'Хлопок-сырец (килограмм)':1 / 0.95 * 0.3,
        '-Пакля хлопчатая (требуется/килограмм)':1 / 0.95 * 0.7,
        }

metadict_detail['_Производство пакли (килограмм)'] = {
        '_Производство пакли (килограмм)':1,
        '-Пакля льняная (требуется/килограмм)':1,
        }
...
metadict_detail['_Швейная мастерская (годовой оборот)'] = {
        #'Швейная мастерская (капитализация)':1/3,
