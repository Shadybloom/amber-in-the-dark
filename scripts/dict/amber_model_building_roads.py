...
metadict_model['Шоссейная дорога (эксплуатация) (километр)'] = {
        # TODO:
            ...
            # Дороги в Эквестрии используются на 9% (40 телег/сутки)
...
metadict_model['Земляное полотно железной дороги (километр)'] = {
        ...
        'Расчистка среднего леса киркомотыгами (квадратный метр)':10 * 1000,
...
metadict_model['Строительство щебёночного шоссе (километр)'] = {
        # TODO:
            ...
            # Чем добыча такого же количества. 
        # https://ru.wikisource.org/wiki/ЭСБЕ/Шоссе
...
metadict_model['Низководный мост (метр)'] = {
        # TODO:
            # Не используется. Вместо этого ГЭСН.
