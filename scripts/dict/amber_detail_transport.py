...
# Заметки:
    ...
    # Пудоверста = 0.0154 тонно-километра (65 пудовёртс/ткм)
    ...
    # amber эквестрийские пони -E "Доставка"
    # amber эквестрийские пони -E "(брутто) (килограмм)"

#----
# Энергозатраты транспортировки (первичная энергия топлива)
    # Транспорт           | МДж/тонно-километр           | Себестоимость СССР 1975
    # ------------------- | ---------------------------- | -----------------------
    # Самолёт             | 30 МДж/ткм                   | 22-56 цента/ткм (2009)
    # Грузовик (дизель)   | 1-2.5                        | 5.05 копеек/ткм
    # Поезд (паровоз)     | 1.3-2.1 (1895 год, Германия) | -
    # Поезд (дизель)      | 0.6-0.9                      | 0.26
    # Электропоезд        | 0.2-0.4                      | 0.26
    # Малые суда          | 0.1-0.15                     | 0.24
    # Танкеры и сухогрузы | 0.05 (50 кДж/ткм)            | 0.19
    # Боинг-747 (71 МВт, 253 м/с, 64 тонны, 11 кг/км) -- 7.2 МДж/ткм (по расходу топлива)
    ...
    #
    # Транспорт           | МДж/пассажиро-километр       | Себестоимость СССР 1975
    # ------------------- | ---------------------------- | -----------------------
    # Водный транспорт    | 3.7-4.4 МДж/пассажиро-км     | -
    # Воздушный транспорт | 2.2-2.5                      | -
    # Электромобиль       | 1.4-7.2                      | -
    # Автобус             | 0.4-1.1                      | -
    # Пассажирский поезд  | 72-540 кДж/пассажиро-км      | -
    # Велосипед           | 36-72                        | -
    # Боинг-747 (71 МВт, 253 м/с, 600 пассажиров, 11 кг/км) -- 770 КДж/пасс-км
    # "Создание современного мира. Материалы и дематериализация." Вацлав Смил
    # http://istmat.info/files/uploads/20265/narhoz_1975_transport.pdf
...
# Автотранспорт:
    # Автомобили по регионам мира (2025, 8 млрд) -- 1.475 млрд
        # Страна        | Людей | Автомобилей | Авто на 10k
        # ------------- | ----- | ----------- | -----------
        # Asia/Oceania  | 3738M | 543 млн     | 1453
        # Europe        | 753   | 413         | 5485
        # North America | 590   | 359         | 6085
        # South America | 440   | 84          | 1909
        # Middle East   | 1162  | 50          | 430
        # Africa        | 1249  | 26          | 208
        # Мир           | 7932  | 1475        | 1860
    # Автомобиль (900 кг стали 60% высокопрочной) -- 100 млн авто/год, это 90 млн тонн стали
    # Производство (США, 1929 год, 123 млн) -- 5.6M автомобилей, +455 авто на 10 000 населения.
    # Производство (США, 1932 год, 123 млн) -- 1.3M автомобилей, +106 авто на 10 000 населения.
    # Обеспеченность (США, 1930 год, 123 млн) -- 24M автомобилей, 1951 авто на 10 000 населения.
    ...
    # Обеспеченность (РСФСР, 1991 год, 148 млн) -- 600 автомобилей и 25 личных грузовиков на 10k
    # Обеспеченность (РФ, 2009 год, 148 млн) -- 2250 автомобилей и 221 всех грузовиков на 10k
    # Обеспеченность (РФ, 2023 год, 150 млн) -- 3220 автомобилей и 310 всех грузовиков на 10k
    # Обеспеченность (Китай, 2011 год, 1338 млн) -- 1345 автомобилей и 224 грузовиков на 10k
    # Обеспеченность (Китай, 2020 год, 1411 млн) -- 1925 автомобилей и 215 грузовиков на 10k
    # Пробег (США, 2019 год) -- 5.2 трлн км, 19 700 км/автомобиль (300-500 часов/год, 100 часов/год пробки)
    # Пробег (Россия, 2019 год) -- 16 000 км/автомобиль; Пробег (Россия, 2022 год) -- 18 700 км/автомобиль
    ...
    # КПД автомобиля 1985 года -- 8.55 литра на 100 км (масса 63% к автомобилю 1970 года)
...
# Inland transport infrastructure spending (2021):
    ...
    # USA -- 0.5% of GDP (7.2 млн км дорог, 109k км шоссе)
    # Germany -- 0.8%
    # Russia -- 0.95%
...
# Флот, водные пути
    ...
    # Российская Империя (1900 год, 136 млн. человек)
        ...
        # Речной флот, Российская Империя (1896 год):
            ...
            # Грузооборот реки Волга (Российская империя 1840 годы) -- 563 млн тонно-километров (до 768 ткм/год)
            ...
            # https://wg-lj.livejournal.com/432836.html
...
# Пассажирские перевозки (путешествия):
    # Пассажирские к грузовым:
        ...
        # https://nkps.livejournal.com/31902.html
        # https://nkps.livejournal.com/49133.html
    # Пассажирооборот по видам транспорта (СССР, 1985 года, 276.3 млн. человек):
        ...
        # Воздушного (СССР, 1985) -- 188.4 млрд. пасс-км (682 км/человека, 1673 км/пассажира)
        # Воздушного (Мир, 2019) -- 68 трлн пасс-км, 4.2 млрд пассажиров, 1900 км/пассажир
        # Авиация, грузопоток (Мир, 2025) -- 60-75 миллионов тонн/год (8.1 кг/чел)
    ...
    # В Эквестрии:
        # |===Пассажирооборот воздушных путей (пассажиро-километров)............. | 1,142
        # |===Пассажирооборот железных дорог (пассажиро-километров).............. | 2,562
...
metadict_detail['Железнодорожное региональное путешествие (пони/день)'] = {
        'Железнодорожное региональное путешествие, туда (часов)':2,
        'Железнодорожное региональное путешествие, обратно (часов)':2,
        'Железнодорожное региональное путешествие, на месте (часов)':20,
...
metadict_detail['Воздушное межрегиональное путешествие (пони/день)'] = {
        # Занимает в среднем 6 дней.
            ...
            # Пегасий планёр (80 км/час) -- 1200 км/сутки (с пересменкой экипажей)
...
metadict_detail['Железнодорожное межрегиональное путешествие (пони/день)'] = {
        # В среднем 1500 километров, 50 км/час поезд, 30 часов.
        'Железнодорожное межрегиональное путешествие, туда (часов)':30 / 6,
        'Железнодорожное межрегиональное путешествие, обратно (часов)':30 / 6,
        'Железнодорожное межрегиональное путешествие, на месте (часов)':((6 * 24) - 30 * 2) / 6,
...
metadict_detail['Речное межрегиональное путешествие (пони/день)'] = {
        # TODO: Речные путешествия. Нужны ли? 224 часа баржа vs 30 часов поезд vs 15 часов планёр.
...
metadict_detail['Воздушное заграничное путешествие (пони/день)'] = {
        # Занимает в среднем 30 дней.
            ...
            # Скоростной планёр (200 км/час) -- 4800 км/сутки (с пересменкой экипажей)
...
metadict_detail['Доставка зерновых (брутто) (килограмм)'] = {
        # От фермы к селению, дальше в город, часть в торговлю по регионам, часть на экспорт.
            # 1) ферма --> селение
            # 2) селение --> городок
...
metadict_detail['Доставка почты (брутто) (килограмм)'] = {
        ...
        # Скорость распространения информации (1851 год) -- 430 км/час (телеграф)
        # Скорость распространения информации (1800 год) -- 55-103 км/день
        # Скорость распространения информации (16 век) -- 31-43 км/день
        'Кантонные грузоперевозки (брутто) (килограмм)':1.0,
...
metadict_detail['Доставка горячей пищи (брутто) (килограмм)'] = {
        ...
        # Годовой рацион с питьём (1200 кг нетто, 2400 брутто):
            # - 2 бит в пределах села (1 час)
            # - 4 бит в пределах кантона (30 минут)
            # - 12 бит в пределах округа (2-4 часа)
            # - 52 бит в пределах региона (8-10 часов)
        # Курьером/планёром на 12 пони (40 кг нетто, 80 брутто):
            # 3.4 бит продукты и готовка.
            # - 0.2 бит в пределах села (1 час)
            # - 0.4 бит в пределах кантона (30 минут)
            # - 0.8-1.6 бит в пределах округа (2-4 часа)
            # - 3.2-4 бит в пределах региона (8-10 часов)
...
metadict_detail['Приусадебные грузоперевозки воды (тонн)'] = {
        ...
        # На семью возят 108 тонн воды в год (160 нормо-часов при 8.3 ткм/тонна)
        # Вода на семью в 5 чел (США, Хилл-Каунти, 1930) -- 300 тонн/год (480 нормо-часов, 2500 км)
        # 8.3 ткм/тонна = 40 ходок на 200 метров до колодца по 25 кг (два ведра)
...
# Транспорт (дистанции):
    ...
    # Среднее расстояние перевозки по видам транспорта:
        ...
        # Электросамокаты -- 1-3 километров.
...
metadict_detail['Маршрут межрегиональный-морской, Балтимэр <-> Мэйнхеттен (тонн)'] = {
        ...
        '_-Работы погрузочно-разгрузочные с судна морского (тонн)':1 * 2,
        }
...
metadict_detail['Воздушные грузоперевозки (тонно-километров)'] = {
        ...
        # ------------ | ----- | ------ | ----- | --- | ---- | ------
        # Планёр лёгк. | 272kg | 544kg  | Полёт | 60  | 101  | 16.5kW
...
metadict_detail['Воздушные грузоперевозки курьерские (тонно-километров)'] = {
        # Доставка горячей пищи из ресторанов и почта. От 10 минут до часа полёта.
        'Воздушные грузоперевозки, планёр лёгкий (тонно-километров)':1,
        '|===Грузооборот воздушных путей (тонно-километров)':1,
        }

metadict_detail['Железнодорожные грузоперевозки (тонно-километров)'] = {
        'Железнодорожные грузоперевозки, поезд грузовой (тонно-километров)':1,
...
# Грузоперевозки (трудозатраты):
    ...
    # Тяговое усилие:
        ...
        # ----------------- | --- | --- | ---- | ---- | -----
        # Лошадиная сила    | -   | 75  | 3.7  | 0.75 | 13.50
        # Тяжеловоз         | 900 | 90  | 3.6  | 0.88 | 15.84
        # Першерон          | 500 | 50  | 3.6  | 0.49 |  8.82
        # Лошадь            | 300 | 45  | 3.6  | 0.44 |  7.92
        # Земнопони         |  70 | 22  | 3.6  | 0.22 |  2.0
        # Мощность: 22kgf × 3.6km/h = 216W
        # Скорость: 0.216kW / 22 kgf to km/h = 3.6 км/час
        # Пища: 22kgf × 3.6km / 40% to kcal = 464 ккал/час
        # КПД мускулов земнопони 40%, у обычных лошадей 21%.
    # Необходимая тяга:
    ...
    # Парусное судно:
        # 3500 часов/год, 6 узлов/час, 39kkm/год (2.9 дистанции Бомбеи-Лондон)
        # 1 HP-hr per 45 ton-miles, 50% КПД = 111 кДж/тонно-километр, 1.254 ГДж/тонна-год
        # Dewhurst, J.F. America’s Needs and Resources, 1955
        # https://www.mdpi.com/1996-1073/7/12/7955
    # Формула тяги самолёта:
        # P = G × V / K / n
        # P -- мощность (киловатт)
        # G -- вес самолета (180 кгс)
        # V -- скорость (100 км/час)
        # K -- аэродинамическое качество (9)
        # n -- КПД винта (0.75)
        # Подстановка:
        # 600 kgf × 100 km/h / 13 / 0.75 = 16.8 kW (планёр)
        # 68 kgf × 100 km/h / 10 / 0.75 = 2.5 kW (пегас)
        # 68 kgf × 200 km/h / 27 / 0.9 = 1.5 kW (рэйнбоу)
        # 8 kgf × 100 km/h / 20 / 0.9 = 121 W (альбатрос)
...
metadict_detail['Воздушные грузоперевозки, планёр тяжёлый (тонно-километров)'] = {
        # Messerschmitt Me.323 Gigant -- 100 кВт/тонна на взлёте.
        # Тяжёлый планёр 625kgf × 159 km/h = 270 kW (18 пегасов, 40 кВт/тонна, 2.0 МДЖ/ткм)
        # Тяжёлый планёр 447kgf × 79 km/h = 96 kW (18 пегасов, 14.3 кВт/тонна, 1.44 МДЖ/ткм)
        # https://ru.wikipedia.org/wiki/Gotha_Go_242
        # https://ru.wikipedia.org/wiki/Gotha_Go_244
        '_-Путь грузового планёра, тяжёлого, 3/6.7 тонны, 80/160 км/час, 96/540 кВт (часов)':1 / (80 * 3),
        }

metadict_detail['Воздушные грузоперевозки, планёр лёгкий (тонно-километров)'] = {
        # Для мелких грузов, почты, а также поселений без взлётной полосы.
        # Лёгкий планёр 124kgf × 205km/h = 69 kW (2 пегаса, 115 кВт/тонна, 4.2 МДж/ткм)
        # Лёгкий планёр 60kgf × 101km/h = 16.5 kW (2 пегаса, 27.5 кВт/тонна, 2 МДж/ткм)
        # Практика авиации: 1 hp / 3 kgf = 25.4m/s (91.3 km/h, 500 футов/раунд)
        '_-Путь грузового планёра, лёгкого, 0.3/0.6 тонны, 100/200 км/час, 17/60 кВт (часов)':1 / (100 * 0.3),
        }

metadict_detail['Железнодорожные грузоперевозки, поезд грузовой (тонно-километров)'] = {
        ...
        # Поезд грузовой 881kgf × 50km/h = 120 kW (24 пегаса, 300 Ватт/тонна, 35 кДж/ткм)
        '_-Путь грузового поезда, 250/400 тонн, 50/50 км/час 120/720 кВт (часов)':1 / (50 * 250),
        }
...
metadict_detail['Морские грузоперевозки, барк стальной (тонно-километров)'] = {
        ...
        # Эксплуатационно-экономические показатели и нормативы работы транспортного флота
            # КПД пароходов (Англия, 1830) -- 2% (деревянный корпус, колесо, морская вода)
            # КПД пароходов (Англия, 1881) -- 10% (стальной корпус, винт, наружные конденсаторы)
        ...
        # Барк стальной 115kN × 18.5km/h = 590 kW (24 пегаса, 200 Ватт/тонна, 82 кДж/ткм)
        # Барк стальной 33kN × 13km/h = 120 kW (24 пегаса, 40 Ватт/тонна, 24 кДж/ткм)
        '_-Путь грузового барка, 1400/3000 тонн, 13/18.5 км/час, 120/720 кВт (часов)':1 / (13 * 1400),
        }
...
metadict_detail['Морские грузоперевозки, барк деревянный (тонно-километров)'] = {
        ...
        # Барк деревянный: 33kN × 13km/h = 120 kW (12 пегасов, 100 W/t, 55 кДж/ткм)
        '_-Путь грузового барка, 600/1200 тонн, 13/18.5 км/час, 120/360 кВт (часов)':1 / (13 * 600),
        }

metadict_detail['Морские грузоперевозки, бриг деревянный (тонно-километров)'] = {
        # Парусность -- 1000 м² (1.6 м²/т водоизмещения):
        # Бриг деревянный: 26kN × 11km/h = 80 kW (8 пегасов, 100 W/t, 87 кДж/ткм)
        '_-Путь грузового брига, 300/600 тонн, 11/18.5 км/час, 80/240 кВт (часов)':1 / (11 * 300),
        }
...
metadict_detail['Речные грузоперевозки, баржа (тонно-километров)'] = {
        # Буксиры, 63% (60 кВТ, 1.7-2.9 узла против течения, 100 км/сутки, 2-7 барж, 2400-9800 тонн)
            ...
            # Один тяжеловоз (0.75 кВт) со скоростью 3-5 км/час тащит баржу 30-50 тонн
            # https://img-fotki.yandex.ru/get/66521/2118499.156/0_f4cce_8c006ca4_XL.png
            # "Энергия и цивилизация" Вацлав Смил
        # Баржа деревянная: 2880 kgf × 7.2km/h = 56.5kW (2 пегаса, 141 Ватт/тонна, 141 кДж/ткм)
        # Баржа деревянная: 800 kgf × 3.6km/h = 7.9kW (2 пегаса, 20 Ватт/тонна, 40 кДж/ткм)
        '_-Путь грузовой баржи, 200/400 тонн, 3.6/7.2 км/час, 8/60 кВт (часов)':1 / (3.6 * 200),
        }
...
metadict_detail['Речные грузоперевозки, баржа (Зебрика) (тонно-километров)'] = {
        ...
        # Спуск по течению: 5.8-7.2 км/час; Подъём по течению: 1.4-0 км/час.
        '_-Путь грузовой баржи, 200/400 тонн, 3.6/7.2 км/час, 8/60 кВт (часов)':1 / (3.6 * 200),
        }
...
metadict_detail['Гужевые грузоперевозки, телега пегасья (тонно-километров)'] = {
        ...
        # Телега+пегас (грунт): 160 kgf × 20km/h = 8.7kW (1 пегас, 7.9 кВт/тонна, 2.6 МДж/ткм)
        # Телега+пегас (шоссе): 35 kgf × 20km/h = 1.9kW (1 пегас, 1.7 кВт/тонна, 0.6 МДж/ткм)
        '_-Путь грузовой телеги, 0.6/1.1 тонны, 20/80 км/час, 4/30 кВт (часов)':1 / (20 * 0.5),
        }
...
metadict_detail['Гужевые грузоперевозки, телега конная (тонно-километров)'] = {
        ...
        # Конные грузоперевозки (1891 год, Варшава)
            ...
            # Энергобаланс перевозки: 3800 / 5556 = 0.7 КЕ/ткм (овса 0.3 КЕ) = 4.13 МДж/ткм
        ...
        # Телега (грунт): 90 kgf × 1.8km/h = 441W (2 пони, 0.74 кВт/тонна, 3.0 МДж/ткм)
        # Телега (шоссе): 18 kgf × 3.6km/h = 177W (2 пони, 0.3 кВт/тонна, 0.6 МДж/ткм)
        '_-Путь грузовой телеги, 0.3/0.6 тонны, 3.6/5.6 км/час, 0.2/0.4 кВт (часов)':1 / (3.6 * 0.3),
        }

metadict_detail['Гужевые грузоперевозки, телега-водовоз конная (тонно-километров)'] = {
        '_-Путь грузовой телеги-водовозки, 0.3/0.6 тонны, 3.6/5.6 км/час, 0.2/0.4 кВт (часов)':1 / (3.6 * 0.3),
        }

metadict_detail['Гужевые грузоперевозки, телега-самосвал конная (тонно-километров)'] = {
        '_-Путь грузовой телеги-самосвала, 0.3/0.6 тонны, 3.6/5.6 км/час, 0.2/0.4 кВт (часов)':1 / (3.6 * 0.3),
        }

metadict_detail['Гужевые грузоперевозки, телега конная (Зебрика) (тонно-километров)'] = {
        '_-Путь грузовой телеги, 0.3/0.6 тонны, 3.6/5.6 км/час, 0.2/0.4 кВт (Зебрика) (часов)':1 / (3.6 * 0.3),
        }
...
metadict_detail['Вьючные грузоперевозки, тележка конная (тонно-километров)'] = {
        ...
        # Тележка (грунт): 45 kgf × 1.8km/h = 221W (1 пони, 0.74 кВт/тонна, 3.0 МДж/ткм)
        # Тележка (шоссе): 9 kgf × 5.6km/h = 137W (1 пони, 0.3 кВт/тонна, 0.6 МДж/ткм)
        '_-Путь грузовой тележки, 0.15/0.3 тонны, 5.6/9.3 км/час, 0.14/0.22 кВт (часов)':1 / (5.6 * 0.15),
        }

metadict_detail['Вьючные грузоперевозки, тележка-водовоз конная (тонно-километров)'] = {
        '_-Путь грузовой тележки-водовозки, 0.15/0.3 тонны, 5.6/9.3 км/час, 0.14/0.22 кВт (часов)':1 / (5.6 * 0.15),
        }

metadict_detail['Вьючные грузоперевозки, тележка конная (Зебрика) (тонно-километров)'] = {
        '_-Путь грузовой тележки, 0.15/0.3 тонны, 5.6/9.3 км/час, 0.14/0.22 кВт (Зебрика) (часов)':1 / (5.6 * 0.15),
        }
...
metadict_detail['_-Путь пассажирского планёра, лёгкого (часов/пассажир)'] = {
        ...
        '_-Путь пассажирского планёра, лёгкого, 4 пассажира, 100/200 км/час, 17/60 кВт (часов)':1 / (4 * 0.5),
        '|===Пассажирооборот воздушных путей (пассажиро-километров)':100,
        }

metadict_detail['_-Путь пассажирского планёра, тяжёлого (часов/пассажир)'] = {
        # 18 пегасов. До 36 пассажиров, среднее заполнение 0.75
        '_-Путь пассажирского планёра, тяжёлого, 36 пассажиров, 80/160 км/час, 96/540 кВт (часов)':1 / (36 * 0.75),
...
metadict_detail['_-Путь пассажирского поезда (часов/пассажир)'] = {
        ...
        # Допускаемая скорость движения поездов:
            # - пассажирских без непрерывных тормозов -- 60 км/час (до 90 км/час)
            # - пассажирских с непрерывными тормозами -- 80 км/час (до 90 км/час)
            # - рабочих.............................. -- 30-45 км/час (<60 км/час)
            # - товарных............................. -- 45 км/час (до 60 км/час)
            # При скорости >50 км/час трение о рельсы значительно возрастает.
        # 36 мест/вагон, 8+2 вагонов/поезд (50/200 тонн), 288 пассажиров, заполнение 0.75
        # 12 мест/вагон, 24+1 вагонов/поезд (50/350 тонн), 288 пассажиров, заполнение 0.75
        # Поезд пассажирский 771kgf × 100km/h = 210 kW (24 пегаса, 1.1 кВт/тонна, 38 кДж/ткм)
        # Поезд пассажирский 881kgf × 50km/h = 120 kW (24 пегаса, 300 Ватт/тонна, 35 кДж/ткм)
        '_-Путь пассажирского поезда, 288 пассажиров, 50/100 км/час, 120/720 кВт-час (часов)':1 / (288 * 0.75),
        '|===Пассажирооборот железных дорог (пассажиро-километров)':50,
        }

metadict_detail['_-Путь пассажирского барка (часов/пассажир)'] = {
        # Стальная махина массой 3000 тонн. 288 пассажиров, заполнение 0.75
        '_-Путь пассажирского барка, 288 пассажиров, 13/18.5 км/час, 120/720 кВт (часов)':1 / (288 * 0.75),
...
metadict_detail['_-Путь пассажирского брига (часов/пассажир)'] = {
        ...
        '_-Путь пассажирского брига, 108 пассажиров, 13/18.5 км/час, 80/240 кВт (часов)':1 / (108 * 0.75),
        '|===Пассажирооборот морских путей (пассажиро-километров)':13,
        }

metadict_detail['_-Путь пассажирской баржи (часов/пассажир)'] = {
        # TODO: пассажирские баржи во всём проигрывают планёрам и поездам.
            # - слишком медленные, требуют сравнительно много энергии.
            # - нужны лёгкие и скоростные пегасьи катера вместо барж.
        # 10/100-тонная баржа. 72 пассажиров, заполнение 0.75
        ...
        # Баржа деревянная: 900 kgf × 9.0km/h = 22.8kW (4 пегаса, 229 Ватт/тонна, 253 кДж/пасс×км)
        # Баржа деревянная: 600 kgf × 7.2km/h = 11.8kW (2 пегаса, 118 Ватт/тонна, 164 кДж/пасс×км)
        '_-Путь пассажирской баржи, 72 пассажиров, 9/9 км/час, 23/120 кВт (часов)':1 / (72 * 0.75),
