...
metadict_detail['Доставка воды для хозяйства (брутто) (килограмм)'] = {
        # TODO: А как насчёт пегасьего водопровода? Римляне же собирали воду с крыш в бассейны двора.
...
# Грузоперевозки (трудозатраты):
    # Трудозатраты (гужевые и вьючные перевозки):
...
metadict_detail['Речные грузоперевозки, баржа (тонно-километров)'] = {
        ...
        # 2.3 узла, 30 кВт: 30 / (2.3*1.852/3.6) * 0.7 = 18 килоньютонов
...
metadict_detail['Гужевые грузоперевозки, телега пегасья (тонно-километров)'] = {
        ...
        # Изрядные требования к конструкции, рессорам и колёсам, функционально это автомобиль.
        # Это в 10 раз менее эффективно, чем речные перевозки (без учёта стоимости барж).
