...
# Грузоперевозки (пирамиды снабжения):
    # Домашние грузоперевозки -- 100 - 300 метров (200 метров, 3 гектара)
        # Селение: колодец, улица, усадьбы вдоль неё, огороды за усадьбами.
        # Усадьбы 30x60 метров, площадь вокруг от 3 до 28 гектаров.
        # - Колодец --> дом
        # - Огород --> дом
        # - Амбар --> дом
    # Сельские грузоперевозки -- 300 - 2000 метров (1100 метров, 95 га)
        # Окрестности: сельские поля, 
        # - Поле --> амбар
        # - Лесополоса --> дровяной склад

    # Кантонные грузоперевозки -- 2-20 километров
        # В пределах кантона. 1200 городков, на каждый около 30 км железной дороги.
        # В каждом городке есть взлётная полоса для 5-тонных 18-пегасных планёров. Ровный участок шоссе.

    # Окружные грузоперевозки -- 25-100 километров
        # В пределах округа. 108 окружных городов, на каждый 250 км железной дороги.
        # Городки связаны с окружными центрами железными дорогами, каналами или мощёными шоссе.
