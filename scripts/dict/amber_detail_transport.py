...
# Заметки (флот)
    ...
    # Торговый флот (Российская иммерия, 1901 год, 136 млн. человек)
    ...
    # Грузооборот российского морского судоходства в 1901 г.
        # - ввоз, 10 585 судов, 9 223 млн. кг грузов (68 кг/человека)
        # - вывоз, 10 393 судов, 8 940 млн. кг грузов (65 кг/человека)
...
metadict_detail['Сельские грузоперевозки воды (тонн)'] = {
        ...
        '|===Грузонапряжённость сельский дорог (тонн)':1,
        }
...
# Грузоперевозки (трудозатраты):
    # Тяговое усилие пони (70 килограмм массы -- 20 килограмм-сил)
    # Тяговое усилие лошади (300 килограмм массы -- 45 килограмм-сил)
    # P = Q/9+12,
    # где:
    # Р — сила тяги;
    # Q — масса лошади (кг);
