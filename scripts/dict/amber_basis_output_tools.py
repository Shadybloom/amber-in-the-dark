...
metadict_detail['|Мебель деревянная шлифованная (верстак слесарный)'] = {
        # Простая крестьянская мебель. шлифованная древесина, чуть шероховая на ощупь.
        }

metadict_detail['|Мебель деревянная шлифованная (верстак столярный)'] = {
        }

metadict_detail['|Мебель деревянная шлифованная (колыбель)'] = {
        }

metadict_detail['|Мебель деревянная шлифованная (кровать двуспальная)'] = {
        }

metadict_detail['|Мебель деревянная шлифованная (кровать односпальная)'] = {
        }

metadict_detail['|Мебель деревянная шлифованная (лавка)'] = {
        }

metadict_detail['|Мебель деревянная шлифованная (стол кухонный, 140x90-см)'] = {
        }

metadict_detail['|Мебель деревянная шлифованная (стол обеденный, 200x110-см)'] = {
        }

metadict_detail['|Мебель деревянная шлифованная (стол парта, 140x90-см)'] = {
        }

metadict_detail['|Мебель деревянная шлифованная (стол письменный, 140x90-см)'] = {
        }

metadict_detail['|Мебель деревянная шлифованная (сундук 300-литров)'] = {
        }

metadict_detail['|Мебель деревянная шлифованная (чертёжная доска)'] = {
        }

metadict_detail['|Мебель деревянная шлифованная (шкаф-буфет)'] = {
        }

metadict_detail['|Мебель деревянная шлифованная (шкаф-гардероб)'] = {
        }

metadict_detail['|Мебель деревянная шлифованная (шкаф-стеллаж книжный)'] = {
        }

metadict_detail['|Мебель деревянная шлифованная (шкаф-стеллаж)'] = {
        }
